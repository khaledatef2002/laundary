            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="phone" class="form-control" id="phone" name="phone" placeholder="@lang('custom.phone')">
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="address">@lang('custom.address')</label>
                        <textarea class="form-control" id="address" name="address" placeholder="@lang('custom.address')"></textarea>
                    </div>
                </div>
            </div>
            <!-- end card -->
